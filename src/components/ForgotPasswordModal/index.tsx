...
const ForgotPasswordModal = ({
  ...
  const checkKeyValue = (key, idx) => {
    if (key === 'Backspace' && isPreviousKeyBackSpace) goPreviousAfterEdit(idx);
    ...
    <Modal visible={visible} transparent={true} onRequestClose={onRequestClose}>
      <ScrollView contentContainerStyle={styles.modalContainer} keyboardShouldPersistTaps='handled'>
        <View style={styles.modalContent}>
          <FeatherButton name={'x-circle'} onPress={onClose} size={ICON.LG} color={GREY[600]}
            style={styles.goBack} />
          ...
          { !codeRecipient
            ...
            : <>
              ...
              <Text style={styles.afterCodeSentText }>
                Nous avons envoyé un e-mail à {codeRecipient} avec le code temporaire.
                Si vous ne l’avez pas reçu, vérifiez votre courrier indésirable, ou réessayez.
              </Text>}
              {(IS_LARGE_SCREEN || !isKeyboardOpen) &&
              ...
              <NiButton caption='Valider' style={styles.button} onPress={sendEmail} loading={isLoading}
