...
export const articles = [
  `Le présent règlement s’applique à toutes les personnes participantes à une action de formation organisée par Compani. Un exemplaire est remis à chaque stagiaire.
...
Toute personne doit respecter les termes du présent règlement durant toute la durée de l’action de formation.`,
  ...
  `La prévention des risques d’accidents et de maladies est impérative et exige de chacunle respect:
...
partir d’un téléphone fixe ou le 112 à partir d’un téléphone portable et alerter un représentant de l’organisme de
formation.`,
...
Le responsable de l’organisme de formation a la charge de l’organisation du scrutin. Il en assure le bon déroulement. Il adresse un procès-verbal de carence, transmis au préfet de région territorialement compétent, lorsque la représentation des stagiaires ne peut être assurée.`,
  ...
  'Les délégués sont élus pour la durée du stage. Leurs fonctions prennent fin lorsqu’ils cessent, pour quelque cause que ce soit, de participer au stage. Si le délégué titulaireet le délégué suppléant ont cessé leurs fonctions avant la fin du stage, il est procédé à une nouvelle élection.',
